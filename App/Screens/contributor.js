...
class Contributor extends React.Component {
  ...
  _renderRow({ item }) {
    return (
      <RkCard rkType="shadowed">
        <View rkCardHeader>
          <Text style={styles.totalText}>{item["@attributes"].org_name}</Text>
        </View>
        <View rkCardContent>
  ...
  async componentDidMount() {
    ...
    let contributors = await this.props.searchContributors(name);
...
export default connect(mapStateToProps, { searchContributors })(Contributor);
